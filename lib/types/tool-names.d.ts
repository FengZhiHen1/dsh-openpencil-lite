...
export declare const OPENPENCIL_TOOL_NAMES: readonly ["openpencil_render", "openpencil_selection", "openpencil_new", "openpencil_create", "openpencil_edit", "openpencil_apply"];
