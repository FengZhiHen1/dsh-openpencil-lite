...
import { OPENPENCIL_APPLY_TOOL_NAME, OPENPENCIL_NEW_TOOL_NAME, OPENPENCIL_RENDER_TOOL_NAME, OPENPENCIL_TOOL_NAMES, } from './tool-names.js';
...
export async function apply(ctx) {
    ...
    disposers.push(ctx.effect(() => hostCtx.tools.register(createDesignRenderTool(controller, viewerAssets)), `dsh-openpencil-lite: ${OPENPENCIL_RENDER_TOOL_NAME} tool`));
    disposers.push(ctx.effect(() => hostCtx.tools.register(createDesignNewTool(editorHost, designOutputServices)), `dsh-openpencil-lite: ${OPENPENCIL_NEW_TOOL_NAME} tool`));
    disposers.push(ctx.effect(() => hostCtx.tools.register(createDesignApplyTool(editorHost, designOutputServices)), `dsh-openpencil-lite: ${OPENPENCIL_APPLY_TOOL_NAME} tool`));
